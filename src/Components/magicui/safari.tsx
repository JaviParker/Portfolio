      ...
      <g clipPath="url(#path0)">
        ...
        {videoSrc && (
          <foreignObject
            ...
            clipPath="url(#roundedBottom)"
          >
            {/* Contenedor relativo para posicionar el loader sobre el video */}
            <div className="relative size-full bg-gray-50 dark:bg-[#1c1c1c]">
              {isLoading && (
              ...
              <video
                className={`size-full overflow-hidden object-cover transition-opacity duration-500 ${
                ...
                muted
                playsInline
                // Este evento apaga el loader cuando hay suficiente data para reproducir
