...
const IMGS: string[] = [
  ...
  "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBhhwlHk642GLOC3S6Xaw72ZMAriWjxkTHgg&s",
  "https://miro.medium.com/v2/resize:fit:2048/1*xDi2csEAWxu95IEkaNdFUQ.png",
...
const RollingGallery: React.FC<RollingGalleryProps> = ({
  ...
  const cylinderWidth: number = isScreenSizeSm ? 1100 : 2500;
  ...
  return (
    <div className="relative h-[500px] w-full overflow-hidden" style={{width: '100vw', zIndex:4}}>
      <div
          ...
          {galleryImages.map((url, i) => (
            ...
            >
              <img
                src={url}
                alt="gallery"
                className="pointer-events-none h-[1200px] w-[900px] rounded-[15px] border-[3px] border-white object-cover transition-transform duration-300 ease-out group-hover:scale-205 sm:h-[150px] sm:w-[900px]"
              />
            </div>
          ))}
        </motion.div>
